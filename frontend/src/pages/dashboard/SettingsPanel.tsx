...
import { Upload, Plus, X, Edit, MapPin, Phone, Globe, Clock, Building, ChevronLeft, ChevronRight, Check } from 'lucide-react';
...
const SettingsPanel = () => {
  ...
  const CircularTimePicker = () => {
    ...
    return (
      <div className={`fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 transition-opacity duration-300 ${isAnimating ? 'opacity-100' : 'opacity-0'}`}>
        <div className={`bg-white rounded-xl p-4 w-full max-w-80 sm:w-96 sm:p-6 shadow-lg transform transition-all duration-300 ${isAnimating ? 'scale-100' : 'scale-95'}`}>
          {/* Header */}
          <div className="text-center mb-4">
            ...
            <div className="text-2xl sm:text-3xl font-mono font-bold text-gray-800 bg-gray-50 rounded py-1 sm:py-2">
          ...
          >
            <div className="w-full h-full border border-gray-200 rounded-full relative bg-white shadow-sm">
              ...
              >
                <div className="absolute w-1.5 h-1.5 bg-blue-500 rounded-full -right-0.5 -top-0.5"></div>
              </div>
            </div>
          </div>
    ...
    <div className="w-full mx-auto p-6 bg-white rounded-xl shadow-lg border border-gray-200 min-h-screen">
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6 mb-6 w-full lg:w-[70%]">
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <div className="relative">
            <div className="w-20 h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center overflow-hidden">
              {imagePreview ? (
                <img
                  src={imagePreview}
                  alt="Company logo"
            ...
            <label className="absolute -top-2 -right-2 w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white hover:bg-blue-600 transition-colors cursor-pointer">
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6 mb-6 w-full lg:w-[70%]">
        ...
        <div className="space-y-3">
          {languages.map((lang) => (
            <div key={lang.code} className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <div key={day} className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <div className={`w-5 h-5 bg-white rounded-full transition-transform ${data.active ? 'translate-x-6' : 'translate-x-0.5'
                      }`}></div>
                  </button>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6 w-[70%]">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Manzilni xaritadan toping</label>
