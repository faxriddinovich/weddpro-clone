    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Ichki va tashqi yetkazib berish usullarini bu yerdan boshqaring.</p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-3 flex gap-2">
                  <button
                    onClick={() => alert("Qo'shimcha sozlamalar (modal yoki route)")}
      ...
      {/* Empty state */}
      {filtered.length === 0 && (
        <div className="mt-10 text-center text-slate-500">Hech qanday xizmat topilmadi. Yangi xizmat qo'shish uchun "Yangi xizmat" tugmasini bosing.</div>
      )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          >
            ...
            <div className="mt-4 grid grid-cols-1 gap-3">
              ...
              <input defaultValue={editing?.name} id="svc-name" className="w-full px-3 py-2 border rounded-md" />

              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-sm text-slate-600">Kategoriya</label>
                  <select defaultValue={editing?.category || "external"} id="svc-cat" className="w-full px-3 py-2 border rounded-md">
                    <option value="external">Tashqi</option>
                    <option value="internal">Ichki</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <input defaultValue={editing?.price} id="svc-price" className="w-full px-3 py-2 border rounded-md" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input defaultValue={editing?.eta} id="svc-eta" className="w-full px-3 py-2 border rounded-md" />
                </div>
                <div>
                  <label className="text-sm text-slate-600">Holati</label>
                  <select defaultValue={editing?.status || "inactive"} id="svc-status" className="w-full px-3 py-2 border rounded-md">
              ...
              <div className="flex items-center gap-2 justify-end mt-4">
                <button onClick={() => { setShowModal(false); setEditing(null); }} className="px-4 py-2 rounded-md border">Bekor qilish</button>
                <button
                  onClick={() => {
