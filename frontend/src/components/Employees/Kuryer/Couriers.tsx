...
export default function Couriers() {
    ...
    const handleAddCourier = () => {
        if (!formData.fullName.trim() || !formData.phone.trim()) {
            toast({
                title: "Xatolik",
                description: "Ism va telefon raqami kiritilishi shart!",
                duration: 3000,
            })
            return;
        }
        ...
        <div className="min-h-screen bg-white rounded-xl shadow-lg border border-gray-200">
            <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <Select value={statusFilter} onValueChange={setStatusFilter}>
                            <SelectTrigger
                                className="w-full sm:w-48 h-11 bg-white shadow-sm outline-none border-gray-200">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                    <Card
                        className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 border-0 ring-1 ring-gray-200">
                    ...
                    <CardContent className="p-0">
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-gray-50/50 border-gray-100 hover:bg-gray-50/70">
                                        <TableHead
                                            className="text-left text-xs font-semibold text-gray-600 uppercase tracking-wide py-4 px-6">To'liq
                                            ism</TableHead>
                                        <TableHead
                                            className="text-left text-xs font-semibold text-gray-600 uppercase tracking-wide py-4 px-6">Telefon
                                            raqam</TableHead>
                                        <TableHead
                                            className="text-left text-xs font-semibold text-gray-600 uppercase tracking-wide py-4 px-6">Oxirgi
                                            faoliyat vaqti</TableHead>
                                        <TableHead
                                            className="ftext-left text-xs font-semibold text-gray-600 uppercase tracking-wide py-4 px-6 text-center">Yetkazilgan
                                            buyurtmalar</TableHead>
                                        <TableHead
                                            className="text-xs font-semibold text-gray-600 uppercase tracking-wide py-4 px-6 text-center">Holati</TableHead>
                                        <TableHead
                                            className="text-xs font-semibold text-gray-600 uppercase tracking-wide py-4 px-6 text-center">Amallar</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                        ...
                                        >
                                            <TableCell className="py-4 px-6">
                                                <div className="flex items-center gap-3">
                                                    <Avatar className="h-10 w-10 ring-2 ring-gray-200">
                                                        ...
                                                        <AvatarFallback
                                                            className="bg-gradient-to-br from-blue-500 to-purple-600 text-white text-sm font-semibold">
                                                            {courier.fullName.split(' ').map(n => n[0]).join('').slice(0, 2)}
                                                        </AvatarFallback>
                                                    </Avatar>
                                                    <div>
                                                        <div
                                                            className="font-semibold text-gray-900">{courier.fullName}</div>
                                            ...
                                            <TableCell className="py-4 px-6 text-center">
                                                <div className="flex items-center justify-center gap-2">
                                                    ...
                                                    <span
                                                        className="font-semibold text-gray-700">{courier.totalOrders}</span>
                        ...
                        {filteredCouriers.length === 0 && (
                            <div className="text-center py-16">
                                <div
                                    className="h-24 w-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <User className="h-12 w-12 text-gray-400"/>
                                </div>
                                <h3 className="text-lg font-semibold text-gray-900 mb-2">Kuryer topilmadi</h3>
                                <p className="text-gray-500 mb-6">Qidiruv so'zini o'zgartiring yoki filterlarni qaytadan
                                    sozlang.</p>
                                <Button
                                    onClick={() => {
                                        setSearchTerm('');
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="pl-8 space-y-3">
                                        <div className="flex justify-between">
                                            ...
                                            <span
                                                className="font-mono font-semibold text-gray-900">{selectedCourier.phone}</span>
                                        </div>
                                        <div className="flex justify-between">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="pl-8 space-y-4">
                                        <div className="flex justify-between">
                                            ...
                                            <span
                                                className="font-bold text-gray-900">{selectedCourier.totalOrders} ta</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Bugun bajarilgan:</span>
                                            <span
                                                className="font-bold text-emerald-600">{selectedCourier.completedToday} ta</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">O'rtacha yetkazish vaqti:</span>
                                            <span
                                                className="font-semibold text-gray-900">{selectedCourier.averageDeliveryTime}</span>
                                        </div>
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span
                                                className="font-semibold text-gray-900">{new Date(selectedCourier.joinedDate).toLocaleDateString('uz-UZ')}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Oxirgi faoliyat:</span>
                                            <span
                                                className="font-semibold text-gray-900">{selectedCourier.lastActivity}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
