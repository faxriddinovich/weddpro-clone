...
import { ArrowLeft, User, Phone, Mail, Briefcase, Building2, MapPin, Calendar, Camera, Save, UserPlus, AlertCircle, Check } from 'lucide-react';
import { n } from 'node_modules/@tanstack/query-core/build/modern/hydration-Cvr-9VdO';
...
const AddEmployees: React.FC = () => {
    ...
    const handleSubmit = async (saveAndAdd: boolean = false) => {
        ...
        try {
            ...
            if (saveAndAdd) {
                // Form ni tozalash va qaytadan boshlash
    ...
    const renderStep1 = () => (
        <div className="space-y-6">
            ...
            <div className="flex flex-col items-center gap-4 p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-blue-400 transition-colors">
                <div className="w-40 h-28 bg-gradient-to-br from-blue-500 to-purple-600 rounded-md shadow-md flex items-center justify-center overflow-hidden">
                    {avatarPreview ? (
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Xodim ma'lumotlarini to'ldiring</p>
                        </div>
                    </div>
                            ...
                            {currentStep === totalSteps ? (
                                <>
                                    <button
                                        ...
                                        disabled={isLoading}
                                        className="flex items-center gap-2 px-6 py-3 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 disabled:opacity-50 transition-colors"
                                    >
                                        <UserPlus className="w-5 h-5" />
                                        {isLoading ? 'Saqlanmoqda...' : 'Saqlash va yana qo\'shish'}
                                    </button>
                                    <button
                                        onClick={() => handleSubmit(false)}
                                        disabled={isLoading}
                                        className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 transition-all transform hover:scale-105"
                                    >
