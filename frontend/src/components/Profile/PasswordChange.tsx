            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500">
                  Bepul tarif rejasiga <span className="font-medium text-orange-600">{mockUser.subscriptionDays} kun qoldi</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <main className="flex-1 p-6 lg:p-8">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-1">Hisobingiz xavfsizligini ta'minlash uchun parolni yangilang</p>
            </div>
