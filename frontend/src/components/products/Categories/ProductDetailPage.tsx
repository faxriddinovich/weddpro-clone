...
const dummyProducts: Product[] = [
  {
    id: "280101",
    name: "Dell XPS 15",
    description: "Dell XPS 15 is a laptop with a 15-inch screen, 16GB of RAM, and 512GB of storage.",
  ...
  },
  {
    ...
    description: "Apple iPad (Gen 10) is a tablet with a 10-inch screen, 16GB of RAM, and 512GB of storage.",
  ...
  },
  {
    ...
    description: "Samsung Galaxy S23 is a smartphone with a 6.1-inch screen, 16GB of RAM, and 512GB of storage.",
  ...
  },
  {
    ...
    description: "Logitech MX Master 3S is a mouse with a 16GB of RAM, and 512GB of storage.",
    image: "https://cdn-icons-png.flaticon.com/512/753/753318.png",
  ...
  },
  {
    ...
    description: "Asus ROG Gaming PC is a gaming laptop with a 15-inch screen, 16GB of RAM, and 512GB of storage.",
    image: "https://cdn-icons-png.flaticon.com/512/753/753318.png",
    category: "Laptop & PC",
    price: 2999,
    sales: 30,
  ...
  },
  {
    ...
    description: "ASUS Zenfone 10 is a smartphone with a 6.1-inch screen, 16GB of RAM, and 512GB of storage.",
    image: "https://cdn-icons-png.flaticon.com/512/892/892458.png",
    category: "Smartphone",
    price: 799,
    sales: 75,
...
const ProductDetailedPage = () => {
  ...
  useEffect(() => {
    if (id) {
      ...
      if (product) {
        ...
        setDiscount(false); // Placeholder, as discount is not in dummy data
        setStatus(product.stockStatus);
      } else {
        console.error(`Product with ID ${id} not found in dummy data`);
        navigate("/dashboard/products/categories"); // Redirect if not found
      }
    }
  }, [id, navigate]);
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Updated product:", { id, image, productName, description, category, price, discount, status });
